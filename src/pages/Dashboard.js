...
console.log("server urls", SocketServer)
...
const Dashboard = () => {
  ...
  const handleCloseMenu = (type) => {
    ...
    if (type === "daily") {
      ...
      UserService.GetLatestDeviceTempData(isDeviceID).then((res) => {
  ...
  useEffect(() => {
    ...
    io.current.on('received_stats_data', (data) => {
      if (isDeviceID == data.device_id) {
        ...
        //For Temperature 
        if (isTemperature) {
          console.log("!!!!!!----- temperature stats data-------!!!!!!!!", data)
          const { T_voltage, T_current, T_power, T_energy, temperature } = data
          setisStaticValue1(T_voltage) // T_voltage
          setisStaticValue2(T_current) // T_current
          setisStaticValue3(T_power) // T_Power
  ...
  }, [isDeviceID, isPower, isPowerTotal, isPowerPhase1, isPowerPhase2, isPowerPhase3, isEnergy, isEnergyTotal, isEnergyPhase1, isEnergyPhase2, isEnergyPhase3, isTemperature]);
                              ...
                              <div className="tags top_tag">
                                    ...
                                    <>
                                      ...
                                      <a
                                        onClick={() => {
                                          ...
                                          //call api for get temperature archive data data
                                          UserService.GetLatestDeviceTempData(isDeviceID).then((res) => {
                                            console.log("energy daily Temp_A data total:", res.data.data.deviceData[0])
                                            const { Temp_A } = res.data.data.deviceData[0]
                                            setisStaticTemperature(Temp_A) // temperature
                                          }).catch(err => {
                                            console.log(err)
                                      ...
                                      <a
                                        onClick={() => {
                                          ...
                                          //call api for get temperature archive data data
                                          UserService.GetLatestDeviceTempData(isDeviceID).then((res) => {
                                            console.log("energy daily Temp_A data phase 1:", res.data.data.deviceData[0])
                                            const { Temp_A } = res.data.data.deviceData[0]
                                            setisStaticTemperature(Temp_A) // temperature
                                          }).catch(err => {
                                            console.log(err)
                                      ...
                                      <a
                                        onClick={() => {
                                          ...
                                          //call api for get temperature archive data data
                                          UserService.GetLatestDeviceTempData(isDeviceID).then((res) => {
                                            console.log("energy daily Temp_A data phase 2:", res.data.data.deviceData[0])
                                            const { Temp_A } = res.data.data.deviceData[0]
                                            setisStaticTemperature(Temp_A) // temperature
                                          }).catch(err => {
                                            console.log(err)
                                      ...
                                      <a
                                        onClick={() => {
                                          ...
                                          //call api for get temperature archive data data
                                          UserService.GetLatestDeviceTempData(isDeviceID).then((res) => {
                                            console.log("energy daily Temp_A data phase 3:", res.data.data.deviceData[0])
                                            const { Temp_A } = res.data.data.deviceData[0]
                                            setisStaticTemperature(Temp_A) // temperature
                                          }).catch(err => {
                                            console.log(err)
                                    ...
                                    <>
                                      ...
                                      <a
                                        onClick={() => {
                                          ...
                                          //call api for get temperature archive data data
                                          UserService.GetLatestDeviceTempData(isDeviceID).then((res) => {
                                            console.log("energy daily Temp_A data m total:", res.data.data.deviceData[0])
                                            const { Temp_A } = res.data.data.deviceData[0]
                                            setisStaticTemperature(Temp_A) // temperature
                                          }).catch(err => {
                                            console.log(err)
                                      ...
                                      <a
                                        onClick={() => {
                                          ...
                                          //call api for get temperature archive data data
                                          UserService.GetLatestDeviceTempData(isDeviceID).then((res) => {
                                            console.log("energy daily Temp_A data m phase 1:", res.data.data.deviceData[0])
                                            const { Temp_A } = res.data.data.deviceData[0]
                                            setisStaticTemperature(Temp_A) // temperature
                                          }).catch(err => {
                                            console.log(err)
                                      ...
                                      <a
                                        onClick={() => {
                                          ...
                                          //call api for get temperature archive data data
                                          UserService.GetLatestDeviceTempData(isDeviceID).then((res) => {
                                            console.log("energy daily Temp_A data m phase 2:", res.data.data.deviceData[0])
                                            const { Temp_A } = res.data.data.deviceData[0]
                                            setisStaticTemperature(Temp_A) // temperature
                                          }).catch(err => {
                                            console.log(err)
                                      ...
                                      <a
                                        onClick={() => {
                                          ...
                                          //call api for get temperature archive data data
                                          UserService.GetLatestDeviceTempData(isDeviceID).then((res) => {
                                            console.log("energy daily Temp_A data m phase 3:", res.data.data.deviceData[0])
                                            const { Temp_A } = res.data.data.deviceData[0]
                                            setisStaticTemperature(Temp_A) // temperature
                                          }).catch(err => {
                                            console.log(err)
                                ...
                                <a
                                  onClick={() => {
                                    ...
                                    io.current.emit("liveGraphData", { user_id: userID, device_id: isDeviceID, objectName: "Temp_A", dataType: null });
                                  }}
                                  style={{ cursor: 'pointer' }}
